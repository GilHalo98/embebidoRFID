/*
    ...
    [=] GN | GND           GPIO13 | D7 [X] ---> SENSOR_PUERTA_ABIERTA
    [=] 3V | 3.3V          GPIO15 | D8 [X] ---> SENSOR_PUERTA_CERRADA
    [ ] EN | RST           GPIO03 | RX [ ]
    [ ] RS | RST           GPIO01 | TX [ ]
    [ ] GN | GND              GND | GN [=]
    [ ] Vi | VCC             3.3V | 3V [=]
    ...
    Ver 0.1.3: Se agregaron variables para el home de puerta cerrada/abierta.

    Ver 0.1.4: Se agrego secuencia de Home en la inicialización del dispositivo.
*/
...
#define RELE_3 14
#define RELE_4 12
#define SENSOR_PUERTA_ABIERTA 13
#define SENSOR_PUERTA_CERRADA 15
...
enum ESTADOS {
    ...
    */
    ...
    // Estado de enviar puerta a home.
    ENVIAR_PUERTA_HOME,
...
unsigned long int TIEMPO_PUERTA_ABIERTA = 3000;
