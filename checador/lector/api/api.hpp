...
namespace ENDPOINTS {
    ...
    */
    ...
    // Endpoint de registro de fallos de inicializacion de perifericos.
    const char* registrarReporteErrorPerifericos = "IoT/registrar/reporte/falloPerifericos";
...
// Registra un reporte de error con los perifericos.
respuestaIoT registrarReporteErrorPerifericos(void);
...
#include "interfaz/reporteErrorPerifericos.cpp"