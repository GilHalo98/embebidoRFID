...
respuestaIoT registrarReporteErrorPerifericos(void) {
    ...
    */
    ...
    String uri = String("http://")
        + String(NETWORKING::ipApi)
        + String(":")
        + String(NETWORKING::portApi)
        + String(NETWORKING::versionApi)
        + String(ENDPOINTS::registrarReporteErrorPerifericos);
    ...
    if(registroHTTP.begin(cliente, uri)) {
        ...
        String body = String("idDispositivoIoT=")
            ...
            + String("Error de inicializacion de perifericos");
